 ...
 */
package id.panicdev.core.ui.ext
...
import id.panicdev.core.ext.isAllPermissionsGranted
import id.panicdev.core.ext.showToast
 ...
 * @param onSuccess Callback when the result is successful.
 */
fun ComponentActivity.checkForPermissions(
